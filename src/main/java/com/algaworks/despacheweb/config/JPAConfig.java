...
@Configuration
@EnableJpaRepositories(basePackageClasses = {ClienteRepo.class}, enableDefaultTransactions = false)
@EnableTransactionManagement
@ComponentScan(basePackageClasses = PaginacaoUtil.class)
public class JPAConfig {
	...
	public DataSource dataSource(){
		...
		return dataSourceLookup.getDataSource("jdbc/despacheWebDB");
	}
	...
	public EntityManagerFactory entityManagerFactory(DataSource dataSource, JpaVendorAdapter jpaVendorAdapter){
		...
		factory.setPackagesToScan(ProtocoloAuditoria.class.getPackage().getName());
